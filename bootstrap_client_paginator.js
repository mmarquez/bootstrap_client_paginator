(function ($) {
    $.fn.extend({
        bootstrap_client_paginator: function (options) {
            var settings = $.extend({
                totalrecords: 0,
                recordsperpage: 0,
                length: 10,
            ...
            return this.each(function () {
                ...
                var inputPage = $('<input/>').attr('type', 'text').addClass('form-control col-md-9').keydown(function (e) {
                ...
                function showLabels(pageIndex) {
                    ...
                    container.append($('<span/>').append($('<b/>').text(pageIndex * settings.recordsperpage + 1)))
                                             ...
                                             .append($('<span/>').text(settings.separatorWord))
                ...
                function buildNavigation(startPage) {
                    ...
                    list.addClass('pagination'); //.css({ width: width });
